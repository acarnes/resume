...
\hspace{20 mm}
   ...
   \        \item Modeled the spread of COVID-19 for continental division hospitals to determine required staff, beds, and ventilators for our division hospitals -- accurate to within 25 COVID ICU patients for a 7 hospital system
            ...
            \item Developed algorithm and web application to overturn insurance company denials -- saves over \$10 million per year
    \end{stuff}
    ...
    {\bf Miscellaneous:} Quantum Field Theory, Statistical Mechanics, Differential Equations, Statistics, \\ 
                         Linear Algebra, Numpy, Sci-kit Learn, Pandas, Keras (Neural Nets), \\ 
